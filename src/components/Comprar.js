        ...
        <div className="row">
          <div className="col-3-of-4">
            ...
            <div className={classes.parrafo}>
              ...
              funcionan como reservas, las cuales podés rechazar o aceptar. En
          ...
          <div className={classes.parrafo}>
            ...
            arrepentimiento por parte del comprador, la seña se pierde; en caso
            contrario donde el que se arrepiente es el vendedor, éste deberá
            devolver el doble de la seña entregada. En el documento queda
            establecido el precio, la fecha o plazo de escrituración, la
            designación del escribano, la identificación del inmueble, los datos
            personales, los informes de inhibición y el dominio. Tené en cuenta
            que pueden pasar 30 días hasta la escrituración y que la instancia
            de la firma del boleto compra-venta no siempre se realiza, sino que
            muchas veces se lleva adelante la escrituración directa.
          </div>
          <div className={classes.parrafo}>
            La documentación que necesitás para poder escriturar es:
            <li>
              El título de la propiedad original inscripto en el Registro de la
              Propiedad Inmueble
            </li>
          ...
          <div className={classes.parrafo}>
            Importante: tenér en cuenta que si alguno de los firmantes no
            ...
            <li>
              Informe de dominio: un informe también emitido por el Registro de
            ...
            <li>
              ...
              que fueron adquiridos antes del 1 de enero del 2018 y que no están
              destinadas a casa-habitación, lo que significa que no tienen uso
              como vivienda única, familiar y de ocupación permanente.{" "}
            </li>
            <br />
            Si el vendedor hace uso de la exención del ITI porque a partir de la
            venta del inmueble va a comprar otra vivienda en el plazo de un año,
            deberá tramitar el certificado a través de la página de la AFIP.
            <li>
            ...
            <li>
              ...
              varía en cada provincia, en CABA es del 3,6 % y en GBA del 2%
            ...
            <li>
              ...
              mediante la página web de AFIP previo a la escrituración, siempre
          ...
          <div className={classes.parrafo}>
            ...
            entrega real y efectiva del inmueble. La división de gastos puede
            acordarse, pero, según usos y costumbres, los gastos que debés
            afrontar como vendedor de un inmueble son para demostrar ser el
            dueño, evidenciar la situación impositiva y jurídica del inmueble y
          ...
          <div className={classes.parrafo}>
            Según cada provincia los costos de los certificados que se piden al
            Registro de la Propiedad Inmueble, los certificados
          </div>
          <div className={classes.parrafo}>
            para evaluar deudas y gravámenes, como así también las tasas
